...
public class TransitSearchService {
    ...
    public TransitSearchResult search(String keyword) throws IOException {
        ...
        List<BusStationResponse> gyeonggiBusStationResults = busStationQueryService.searchByGyeonggiStationName(keyword);
        List<SubwayStation> subwayStationResults = subwayStationRepository.searchBySubwayStationName(keyword, 10);

        return TransitSearchResult.of(busRouteResults, busStationResults, gyeonggiBusStationResults, subwayStationResults);
    }
